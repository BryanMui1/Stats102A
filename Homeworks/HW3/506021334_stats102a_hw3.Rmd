...
```{r 2_1b}
pat_1_b <- "\\b[a-zA-z][a-zA-z][a-zA-z][a-zA-z]"
...
```{r 2_1c}
pat_1_c <- "\\b[a-zA-z][a-zA-z][a-zA-z][a-zA-z]"
str_view(txt, pat_1_c)
```

Find cards.txt and write the regex patterns to identify all the valid card numbers with the correct formatting rules:
